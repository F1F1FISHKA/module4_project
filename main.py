...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        btn_open_dialog = tk.Button(toolbar, bg='#f0f0f0', bd=0,
        ...
        self.update_img = tk.PhotoImage(file='./img/update.png').subsample(15,15)
        btn_edit_dialog = tk.Button(toolbar, bg='#f0f0f0', bd=0, 
                                    image=self.update_img, command=self.open_update_dialog)
        btn_edit_dialog.pack(side=tk.LEFT)

        # создание кнопки удаления записи
        self.delete_img = tk.PhotoImage(file='./img/delete.png').subsample(15,15)
        btn_delete = tk.Button(toolbar, bg='#f0f0f0', bd=0, 
                               image=self.delete_img, command=self.delete_records)
        btn_delete.pack(side=tk.LEFT)

        # кнопка поиска
        self.search_img = tk.PhotoImage(file='./img/search.png').subsample(15,15)
        btn_search = tk.Button(toolbar, bg='#f0f0f0', bd=0,
                               image=self.search_img, command=self.open_search_dialog)
        btn_search.pack(side=tk.RIGHT)

        # кнопка обновления
        self.refresh_img = tk.PhotoImage(file='./img/refresh.png').subsample(15,15)
        btn_refresh = tk.Button(toolbar, bg='#f0f0f0', bd=0, 
